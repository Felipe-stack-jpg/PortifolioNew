...
const sitemap = [
  ...
  const socials = [
    {
      label: 'GitHub',
      href: 'https://github.com/Felipe-stack-jpg'
    },
    {
      label: 'LinkedIn',
      href: 'https://www.linkedin.com/in/felipe-amorim-04a6172a5/'
    },
    {
      label: 'Instagram',
      href: 'https://www.instagram.com/eaelip/'
    },
  ];
        ...
        <div className="container">
            ...
            <div className="lg:grid lg:grid-cols-2">
                ...
                <div className="mb-10">
                    ...
                    <ButtonPrimary 
                    href="mailto:lipeamorim191@gmail.com"
                    label="Start project"
                    icon="chevron_right"
                    classes="reveal-up"
                    />
            ...
            <div className="flex items-center justify-between pt-10 mb-8">
                ...
                <a href="/" className="logo reveal-up">
                  ...
                  <p className="text-zinc-500 text-sm reveal-up">
                    &copy; 2024 <span className="text-zinc-200">Felipe Amorim</span>
                  </p>
